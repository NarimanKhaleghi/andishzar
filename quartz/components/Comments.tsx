...
export default ((opts: Options) => {
  const Comments: QuartzComponent = ({ displayClass, cfg, fileData }: QuartzComponentProps) => {
    ...
    const isExcludedPage = fileData.slug === "index" || fileData.slug === "404" || fileData.slug.startsWith("tags/") || fileData.slug.startsWith("0.-نقطه-شروع-😄/") || fileData.slug.startsWith("1.-بذر-ها-🌱/") || fileData.slug.startsWith("2.-نهال-ها-🌿/") || fileData.slug.startsWith("4.-درختچه-ها-🌲/") || fileData.slug.startsWith("5.-درختان-🌳/") || fileData.slug.startsWith("3.-گیاهان-🌾/") || fileData.slug.startsWith("6.-جنگل-ها-🏞/")
